...
INCLUDE "text/ViridianOldRodHouse.asm"
INCLUDE "text/VermilionSprayduckHouse.asm"
...
INCLUDE "text/CeruleanGoodRodHouse.asm"
INCLUDE "text/FuchsiaSuperRodHouse.asm"
