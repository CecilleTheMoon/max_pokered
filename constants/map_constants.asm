...
DEF FIRST_INDOOR_MAP EQU const_value
	...
	map_const VIRIDIAN_OLD_ROD_HOUSE,         4,  4 ; $6F
	map_const CERULEAN_GOOD_ROD_HOUSE,        4,  4 ; $70
	...
	map_const VERMILION_SPRAYDUCK_HOUSE,      4,  4 ; $A3
	map_const FUCHSIA_SUPER_ROD_HOUSE,        4,  4 ; $A4
