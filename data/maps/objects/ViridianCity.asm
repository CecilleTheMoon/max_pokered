...
ViridianCity_Object:
	...
	warp_event 31, 25, VIRIDIAN_OLD_ROD_HOUSE, 1
	...
	bg_event 23, 17, TEXT_VIRIDIANCITY_TRAINERS_SCHOOL_SIGN
	...
	object_event 31, 22, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER2
