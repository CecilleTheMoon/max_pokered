...
Route4HS:
	db ROUTE_4, ROUTE4_TM_FOCUS_ENERGY, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_CHARGE_BEAM, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,         SHOW
	db ROUTE_12, ROUTE12_TM_DRAGONBREATH, SHOW
	db ROUTE_12, ROUTE12_IRON,            SHOW
Route15HS:
	db ROUTE_15, ROUTE15_TM_MOONBLAST, SHOW
Route16HS:
...
PokemonTower6FHS:
	...
	db POKEMON_TOWER_6F, POKEMONTOWER6F_TM_WILL_O_WISP, SHOW
PokemonTower7FHS:
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_BODY_SLAM, SHOW
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_BULK_UP,    SHOW
...
RockTunnelB1FHS:
	db ROCK_TUNNEL_B1F, ROCKTUNNELB1F_TM_ROCK_SLIDE, SHOW
SilphCo2FHS:
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_TM_DOUBLE_EDGE, SHOW
...
SilphCo9FHS:
	...
	db SILPH_CO_9F, SILPHCO9F_TM_ICE_BEAM, SHOW
SilphCo10FHS:
...
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_X_SCISSOR,     SHOW
SafariZoneNorthHS:
...
SafariZoneCenterHS:
	db SAFARI_ZONE_CENTER, SAFARIZONECENTER_TM_SLUDGE_BOMB, SHOW
CeruleanCave2FHS:
...
VictoryRoad1FHS:
	db VICTORY_ROAD_1F, VICTORYROAD1F_TM_HURRICANE, SHOW
	db VICTORY_ROAD_1F, VICTORYROAD1F_RARE_CANDY,    SHOW
VictoryRoadB1FHS:
	db VICTORY_ROAD_B1F, VICTORYROADB1F_MOLTRES, SHOW
ChampionsRoomHS:
...
SeafoamIslandsB3FHS:
	db SEAFOAM_ISLANDS_B3F, SEAFOAMISLANDSB3F_TM_BLIZZARD, SHOW
