...
InternalMapEntries:
	...
	internal_map ROCK_TUNNEL_B2F,               14,  3, RockTunnelName
	internal_map VICTORY_ROAD_1F,                0,  4, VictoryRoadName
	internal_map VICTORY_ROAD_B1F,               0,  4, VictoryRoadName
	internal_map VICTORY_ROAD_OAKS_ROOM,         0,  4, VictoryRoadName
	internal_map VIRIDIAN_OLD_ROD_HOUSE,         2,  8, ViridianCityName
	internal_map CERULEAN_GOOD_ROD_HOUSE,       10,  2, CeruleanCityName
	...
	internal_map VERMILION_SPRAYDUCK_HOUSE,     10,  9, VermilionCityName
	...
	internal_map ROUTE_12_HOUSE,                14, 10, Route12Name
